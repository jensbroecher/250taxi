...
// alert(phoneisvalidatednow);
    ...
    $.ajax({
        ...
        success: function(html){
            alert('Registration successful! Welcome to the 250 Taxi experience where we connect you with the closest taxi to you. '+first_name+' '+last_name+'! You will receive an E-Mail with your account details. Enjoy your ride!\n\nFor more info call 0783000096.');
            // document.location.href = 'login.html';
