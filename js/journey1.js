...
function journey_has_boarded() {
    ...
    localStorage.setItem("logupdate", "" + userid + "*" + driverid + "*boarded*User" + clientid + " boarded with Driver" + driverid + "");
    logupdate_v2();
...
function journey_not_yet_boarded() {
    ...
    var userid = localStorage.getItem('userid');
    var driverid = localStorage.getItem("pickdriver_id");
    localStorage.setItem("logupdate", "" + userid + "*" + driverid + "*not_boarded*User" + clientid + " has not yet boarded with Driver" + driverid + "");
    logupdate_v2();
...
function call() {
    ...
    $.get("https://250taxi.com/db/partner/taxi_id_get_phone.php?id_no=" + driverid + "", function (data) {
        ...
        var userid = localStorage.getItem('userid');
        var driverid = localStorage.getItem("pickdriver_id");
        localStorage.setItem("logupdate", "" + userid + "*" + driverid + "*phone*User" + clientid + " calls phone  " + phonenumber + " of Driver" + driverid + "");
        logupdate_v2();
        ...
        if (phonenumber == "no_number") {
            ...
            var userid = localStorage.getItem('userid');
            var driverid = localStorage.getItem("pickdriver_id");
            localStorage.setItem("logupdate", "" + userid + "*" + driverid + "*phone missing*No phone number found!");
            logupdate_v2();
...
function chat() {
    ...
    var userid = localStorage.getItem('userid');
    var driverid = localStorage.getItem("pickdriver_id");
    localStorage.setItem("logupdate", "" + userid + "*" + driverid + "*chat*User" + userid + " started chat with Driver" + driverid + ".");
    logupdate_v2();
